-- ============================================================
-- Seed do catálogo de produtos Splash Piscinas (v2 — CDN corrigido)
-- Execute no SQL Editor do Supabase
-- DELETE FROM produtos; -- descomente para re-popular
-- ============================================================
...
(
  ...
  '["Pastilha de Porcelana Atlas"]'::jsonb,
  '["https://cdn.splashpiscinas.com/assets/img/nassau/nassau-azul-4.png", "https://cdn.splashpiscinas.com/assets/img/nassau/nassau-dia01.png", "https://cdn.splashpiscinas.com/assets/img/nassau/nassau-dia02.png", "https://cdn.splashpiscinas.com/assets/img/nassau/cores-modelos-nassau.jpg"]'::jsonb,
  true,
  5
),
(
